...
/*   Updated: 2024/02/17 18:19:23 by cpeset-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * @details The assignation operator is called when the ScavTrap is assigned another ScavTrap.
 * 
 * @date 23/01/2024 18:30:00
 * @dir ex03/ScavTrapClass/src
 * @file ScavTrap.cpp
...
/**
 * @name ScavTrap (constructor with parameters)
 * @brief Constructor implementation.
 * 
 * Initializes the ScavTrap with the name, hit points, energy points, and attack damage of the source.
 * Displays a birth message.
 ...
 * @return void
 * 
 * @details The constructor with parameters is called when the ScavTrap is created with a name.
 * 
 * @date 23/01/2024 18:30:00
 * @dir ex03/ScavTrapClass/src
 * @file ScavTrap.cpp
...
/**
 * @name attack
 * @brief Attack function implementation.
 * 
 * Attacks the target if the ScavTrap is alive and has enough energy points.
 * Displays a message.
 * 
 * @param target The target to attack.
 * @return void
 * 
 * @details The attack function is called when the ScavTrap attacks a target.
 * 
 * @date 23/01/2024 18:30:00
 * @dir ex03/ScavTrapClass/src
 * @file ScavTrap.cpp
